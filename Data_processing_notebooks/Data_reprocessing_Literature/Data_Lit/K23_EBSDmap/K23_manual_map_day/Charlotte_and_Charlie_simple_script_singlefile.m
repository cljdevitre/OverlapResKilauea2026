...
% Set path & file names
pname = "/Users/cljd/pCloud Drive/WORK-GENERAL/POSTDOC-UCB/BERKELEY-VIBE/Documents/Projects/PrePostCaldera_Kil2025/Github_repo/" + ...
    "Data_processing_notebooks/Data_reprocessing_Literature/Data_Lit/K23_EBSDmap/K23_manual_map_day";


file="K23_1 - EBSD Data.ctf";
...
grain_div_angle=2; % Grain definition angle
...
exportgraphics(fig,  fullfile(pname, filename + "_Grains"+ ".pdf"), 'ContentType', "vector");
